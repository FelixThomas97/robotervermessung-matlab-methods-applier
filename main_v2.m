...
%%  Simulierte Ist-Bahn aus Abb-Studio
% filename_excel = 'soll_iso_diagonal_l630_v2000_1x.xlsx';  
% filename_json = 'data_ist';   % .json wird später hinzugefügt 
% extract_ist_file_simulation(filename_excel);
% 
% 
% x_ist = data_ist_simulation{:,8};
% y_ist = data_ist_simulation{:,9};
% z_ist = data_ist_simulation{:,10};
% trajectory_soll = [x_ist y_ist z_ist];
% 
% generate_trajectory_struct_simulation(trajectory_soll, defined_velocity);
...
if split == true % Bahn soll zerlegt werden
    ...
    for i = 1:1:wdh_teilbahn
        ...
        fields_soll = fieldnames(data_soll); % für interpolierte Sollbahn
