...
generate_soll_vicon(abb_base_points,vicon,vicon_transformed,base_points_vicon,base_points_idx,base_points_dist,keypoints_faktor, 1.5)
...
for i = 1:1:num_trajectories 
    ...
    dataist_vicon(trajectories_ist{i},trajectory_header_ids(i))
    ...
    if generate_soll == true
        header2struct(trajectory_header_ids(i), header_data, timestamp, trajectories_ist{i}, trajectories_soll{i}, generate_soll);
    else
        header2struct(trajectory_header_ids(i), header_data, timestamp, trajectories_ist{i}, trajectories_abb{i}, generate_soll);
    end
...
for i = 1:1:num_segments
    ...
    dataist_vicon(segments_ist{i},trajectory_header_ids_segments(i),segment_ids(i))
