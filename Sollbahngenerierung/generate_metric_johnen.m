function generate_metric_johnen(trajectory_header_id,maxDistance_selintdtw, avDistance_selintdtw, ...
    ...
    % DTW Johnen
    metrics_johnen.dtw_max_distance = maxDistance_selintdtw;
    metrics_johnen.dtw_average_distance = avDistance_selintdtw;
    metrics_johnen.dtw_distances = distances_selintdtw;
    metrics_johnen.dtw_X = X_selintdtw;
    metrics_johnen.dtw_Y = Y_selintdtw;
    metrics_johnen.dtw_accdist = accdist_selintdtw;
