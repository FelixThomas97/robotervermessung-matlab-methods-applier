function [frechet_av, frechet_dist, frechet_distances, frechet_path, frechet_matrix, frechet_soll, frechet_ist] = fkt_discreteFrechet(trajectory_soll, trajectory_ist, pflag)
    if nargin < 3 
        pflag = false; 
    end
    ...
    frechet_soll = X(frechet_path(:,1),:);
    frechet_ist = Y(frechet_path(:,2),:);
    ...
    % Keine assignin-Aufrufe mehr - die Werte werden als Funktionsrückgaben zurückgegeben
end